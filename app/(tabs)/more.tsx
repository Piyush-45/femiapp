...
const PlanCard = ({ title, price, features, isSelected, onPress }) => (
  <TouchableOpacity 
...
export default function More() {
  ...
  const handlePlanSelection = (planType, amount) => {
    router.push({
      pathname: '/payment',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <PlanCard
          ...
          onPress={() => handlePlanSelection('basic', '350,000')}
        />
        ...
        <PlanCard
          ...
          isSelected={true}
          onPress={() => handlePlanSelection('comprehensive', '600,000')}
        />
      </ScrollView>
    </SafeAreaView>
  );
